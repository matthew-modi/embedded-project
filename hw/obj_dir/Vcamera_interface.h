...
VL_MODULE(Vcamera_interface) {
  public:
    ...
    VL_IN8(vsync,0,0);
    VL_IN8(d,7,0);
    VL_IN8(shutter_raw,0,0);
    VL_OUT8(fifo_enable,0,0);
    VL_OUT(wide_bit_out,31,0);
    
    // LOCAL SIGNALS
    // Internals; generally not touched by application code
    CData/*0:0*/ camera_interface__DOT__rst;
    ...
    CData/*0:0*/ camera_interface__DOT__uut8__DOT__Q1;
    CData/*0:0*/ camera_interface__DOT__uut8__DOT__Q2;
    CData/*0:0*/ camera_interface__DOT__uut8__DOT__Q0;
    CData/*3:0*/ camera_interface__DOT__uut8__DOT__u1__DOT__counter;
    ...
    CData/*3:0*/ __Vdly__camera_interface__DOT__uut8__DOT__u1__DOT__counter;
    CData/*0:0*/ __VinpClk__TOP__camera_interface__DOT__rst;
    CData/*0:0*/ __Vclklast__TOP__pclk;
    CData/*0:0*/ __Vclklast__TOP____VinpClk__TOP__camera_interface__DOT__rst;
    CData/*0:0*/ __Vchglast__TOP__camera_interface__DOT__rst;
  ...
  public:
    ...
    static void _initial__TOP__5(Vcamera_interface__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _sequent__TOP__1(Vcamera_interface__Syms* __restrict vlSymsp);
    static void _sequent__TOP__2(Vcamera_interface__Syms* __restrict vlSymsp);
    ...
    static void _settle__TOP__4(Vcamera_interface__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void traceChgThis__8(Vcamera_interface__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
